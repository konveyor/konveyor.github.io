...
Planning takes a few minutes.

    ![No project inputs]({{ site.baseurl }}/assets/images/migration-workflow/14-new-plan.jpeg)

Now that we have generated a plan file we can move on to the [Transform](/tutorials/migration-workflow/transform) phase which generates the output we need to deploy our app to Kubernetes.
